          ...
          <div className="flex item-center justify-center w-full h-full">
            ...
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <Cloud className="w-6 h-6 text-zinc-500 mb-1" />
                <p className="mb-2 text-sm text-zinc-700">
                  <span className="font-semibold">Click to upload</span> or drag to drop
                </p>
                <p className="text-xs text-zinc-500">MP3 (up to 4MB)</p>
              </div>
